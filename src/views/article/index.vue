...
import {articleStore, configStore} from "@/stores"
...
<template>
  <el-row :gutter="20">
    <el-col :sm="18" :xs="24">
      <el-card>
        <MdPreview :theme="getIsDark ? 'dark' : 'light'" :editor-id="id" :model-value="articleContent"/>
        <div class="m-[20px] border-amber-50">
          <el-card >
            <div class="w-[100%] p-[10px]">
              <div class="item flex items-center w-[100%]">
                <div class="label">文章作者</div>
                <div class="value">
                  <a class="underline" href="http://top/#/home" target="_blank">M</a>
                </div>
              </div>
              <div class="item flex items-center w-[100%]">
              ...
              <div class="item flex items-center w-[100%]">
                ...
                <div class="value">
                  <a class="underline" href="http://mrzym.top/#/article?id=6">http://mrzym.top/#/article?id=6</a>
                </div>
              </div>
              <div class="item flex items-center w-[100%]">
    ...
    <el-col :sm="6" :xs="0">
      <el-affix style="width: inherit" :offset="60">
        <el-card>
          <div class="w-[100%] max-h-[80vh] py-[0.5rem]">
            <MdCatalog :editor-id="id" :scroll-element="scrollElement" :offset-top="80" :scroll-element-offset-top="60"/>
          </div>
        </el-card>
      </el-affix>
    </el-col>
